...
?>
    ...
    <div>
        <div class="janela-cadastro oculta" id="divCadastroFornecedor">
            <span class="titulo-janela">Cadastro de Fornecedor em construção...</span>
            <form id="form-cadastro" action="../back/putProduto.php" method="POST">
                ...
                <div class="form-row">
                    ...
                    <button type="button" class="btn-pesquisar" onclick="limpaCadastroAlternaEdicao('divCadastroFornecedor','divConsultaFornecedores');">Cancelar</button>
                </div>
            </form>
        </div>
        ...
        ?>
        <div class="janela-consulta" id="divConsultaFornecedores">
            ...
            buttons: [
                {
                    text: 'Novo Produto',
                    action: function () {
                        limpaCadastroAlternaEdicao("divCadastroFornecedor","divConsultaFornecedores");
                    }
                },
                {
                    ...
                    action: function () {
                        ...
                        if (selectedRow) {
                            ...
                            alternaCadastroConsulta("divCadastroFornecedor","divConsultaFornecedores");
                        } else {
