...
<body>
    ...
    <?php
    session_start(); //Apenas inicializa o uso da sessão, não força login
    ...
    <div class="form-container">
        ...
        <form class="form-content" action="../../Back/cadastro_usuario.php" method="POST" onsubmit="return validateForm()">
            
            <!-- Seleção entre CPF e CNPJ -->
            <div class="form-row">
                <div class="form-group">
                    <label>
                        <input type="radio" name="tipo_pessoa" value="cpf" onclick="toggleFields()" required> CPF
                    </label>
                    <label>
...
<script src="../JavaScript/cadastro-usuario.js"></script>
</html>