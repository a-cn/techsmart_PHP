...
//Atualiza o status do fornecedor para ativo (1)
$sql = "UPDATE Fornecedor SET ativo = 1 WHERE fornecedor_id = ?";
$params = [$fornecedor_id];

$stmt = sqlsrv_query($conn, $sql, $params);

if ($stmt === false) {
    echo json_encode(['sucesso' => false, 'mensagem' => 'Erro ao reativar fornecedor.', 'erro' => sqlsrv_errors()]);
} else {
